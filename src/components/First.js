    ...
    <div>
      <div id="root">
        <nav className="bg-[#FFF7E2] flex justify-between px-20 items-center p-5">
          ...
          <div className="flex text-md justify-start gap-4 nav32">
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <div className="flex justify-around items-center h-20 w-2/3 sec12">
            <select className="px-5 py-2  bg-gray-200 rounded-lg outline-none sec12c " >
            ...
            <select className="px-5 py-2   bg-green-100 rounded-lg outline-none sec12c">
